...
query_workspace_dns_least_squares :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
...
query_workspace_dns_least_squares_svd :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
...
query_workspace_dns_least_squares_dc :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
...
query_workspace_dns_least_squares_qr :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
...
query_workspace_dns_least_squares_tall_skinny :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    trans: TransposeMode = .None,
) -> (
...
query_workspace_dns_least_squares_tall_skinny_qr :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    trans: TransposeMode = .None,
) -> (
...
query_workspace_dns_least_squares_equality_constrained :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
...
query_workspace_dns_gauss_markov_linear_model :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
...
query_workspace_dns_least_squares_svd_simple :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
