...
query_workspace_dns_cholesky_condition :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    rwork_size: int,
...
query_workspace_dns_pd_solve_expert :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    rwork_size: int,
...
query_workspace_dns_pd_solve_extra_expert :: proc(
    A: ^Matrix($T),
    n_err_bnds: int = 3,
) -> (
    work_size: int,
...
query_workspace_dns_cholesky_refine :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    rwork_size: int,
...
query_workspace_dns_cholesky_refine_expert :: proc(
    A: ^Matrix($T),
    n_err_bnds: int = 3,
) -> (
    work_size: int,
