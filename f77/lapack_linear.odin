...
foreign lib {
	...
	cposvx_ :: proc(fact: ^char, uplo: ^char, n: ^blasint, nrhs: ^blasint, A: ^complex64, lda: ^blasint, AF: ^complex64, ldaf: ^blasint, equed: ^byte, S: ^f32, B: ^complex64, ldb: ^blasint, X: ^complex64, ldx: ^blasint, rcond: ^f32, ferr: ^f32, berr: ^f32, work: ^complex64, rwork: ^f32, info: ^Info, l_fact: c.size_t = 1, l_uplo: c.size_t = 1, l_equed: c.size_t = 1) ---
	dposvx_ :: proc(fact: ^char, uplo: ^char, n: ^blasint, nrhs: ^blasint, A: ^f64, lda: ^blasint, AF: ^f64, ldaf: ^blasint, equed: ^byte, S: ^f64, B: ^f64, ldb: ^blasint, X: ^f64, ldx: ^blasint, rcond: ^f64, ferr: ^f64, berr: ^f64, work: ^f64, iwork: ^blasint, info: ^Info, l_fact: c.size_t = 1, l_uplo: c.size_t = 1, l_equed: c.size_t = 1) ---
	sposvx_ :: proc(fact: ^char, uplo: ^char, n: ^blasint, nrhs: ^blasint, A: ^f32, lda: ^blasint, AF: ^f32, ldaf: ^blasint, equed: ^byte, S: ^f32, B: ^f32, ldb: ^blasint, X: ^f32, ldx: ^blasint, rcond: ^f32, ferr: ^f32, berr: ^f32, work: ^f32, iwork: ^blasint, info: ^Info, l_fact: c.size_t = 1, l_uplo: c.size_t = 1, l_equed: c.size_t = 1) ---
	zposvx_ :: proc(fact: ^char, uplo: ^char, n: ^blasint, nrhs: ^blasint, A: ^complex128, lda: ^blasint, AF: ^complex128, ldaf: ^blasint, equed: ^byte, S: ^f64, B: ^complex128, ldb: ^blasint, X: ^complex128, ldx: ^blasint, rcond: ^f64, ferr: ^f64, berr: ^f64, work: ^complex128, rwork: ^f64, info: ^Info, l_fact: c.size_t = 1, l_uplo: c.size_t = 1, l_equed: c.size_t = 1) ---
	...
	cptsvx_ :: proc(fact: ^byte, n: ^blasint, nrhs: ^blasint, D: ^f32, E: ^complex64, DF: ^f32, EF: ^complex64, B: ^complex64, ldb: ^blasint, X: ^complex64, ldx: ^blasint, rcond: ^f32, ferr: ^f32, berr: ^f32, work: ^complex64, rwork: ^f32, info: ^Info, l_fact: c.size_t = 1) ---
	dptsvx_ :: proc(fact: ^byte, n: ^blasint, nrhs: ^blasint, D: ^f64, E: ^f64, DF: ^f64, EF: ^f64, B: ^f64, ldb: ^blasint, X: ^f64, ldx: ^blasint, rcond: ^f64, ferr: ^f64, berr: ^f64, work: ^f64, info: ^Info, l_fact: c.size_t = 1) ---
	sptsvx_ :: proc(fact: ^byte, n: ^blasint, nrhs: ^blasint, D: ^f32, E: ^f32, DF: ^f32, EF: ^f32, B: ^f32, ldb: ^blasint, X: ^f32, ldx: ^blasint, rcond: ^f32, ferr: ^f32, berr: ^f32, work: ^f32, info: ^Info, l_fact: c.size_t = 1) ---
	zptsvx_ :: proc(fact: ^byte, n: ^blasint, nrhs: ^blasint, D: ^f64, E: ^complex128, DF: ^f64, EF: ^complex128, B: ^complex128, ldb: ^blasint, X: ^complex128, ldx: ^blasint, rcond: ^f64, ferr: ^f64, berr: ^f64, work: ^complex128, rwork: ^f64, info: ^Info, l_fact: c.size_t = 1) ---
