...
query_workspace_band_pd_condition :: proc(
    AB: ^BandedMatrix($T),
) -> (
    work: int,
    rwork: int,
...
query_workspace_band_pd_refine :: proc(
    AB: ^BandedMatrix($T),
) -> (
    work: int,
    rwork: int,
...
query_workspace_band_pd_solve_expert :: proc(
    AB: ^BandedMatrix($T),
) -> (
    work: int,
    rwork: int,
...
query_result_sizes_band_pd_solve_expert :: proc(
    AB: ^BandedMatrix($T),
    B: ^Matrix(T),
) -> (
    S_size: int,
...
query_result_sizes_band_pd_equilibrate :: proc(
    AB: ^BandedMatrix($T),
) -> (
    S_size: int,
) where is_float(T) ||
...
query_result_sizes_band_pd_refine :: proc(
    B: ^Matrix($T),
) -> (
    ferr_size: int,
    berr_size: int,
