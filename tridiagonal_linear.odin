...
tridiagonal_solve_factorized :: proc(
	...
	when T == f32 {
		lapack.sgttrs_(&trans_c, &n_int, &nrhs_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(du2), raw_data(ipiv), raw_data(B.data), &ldb, &info)
	} else when T == f64 {
		lapack.dgttrs_(&trans_c, &n_int, &nrhs_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(du2), raw_data(ipiv), raw_data(B.data), &ldb, &info)
	} else when T == complex64 {
		lapack.cgttrs_(&trans_c, &n_int, &nrhs_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(du2), raw_data(ipiv), raw_data(B.data), &ldb, &info)
	} else when T == complex128 {
		lapack.zgttrs_(&trans_c, &n_int, &nrhs_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(du2), raw_data(ipiv), raw_data(B.data), &ldb, &info)
	}
...
tridiagonal_condition_real :: proc(
	...
	when T == f32 {
		lapack.sgtcon_(&norm_c, &n_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(du2), raw_data(ipiv), &anorm_val, &rcond, raw_data(work), raw_data(iwork), &info)
	} else when T == f64 {
		lapack.dgtcon_(&norm_c, &n_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(du2), raw_data(ipiv), &anorm_val, &rcond, raw_data(work), raw_data(iwork), &info)
	}
...
tridiagonal_condition_complex :: proc(
	...
	when Cmplx == complex64 {
		lapack.cgtcon_(&norm_c, &n_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(du2), raw_data(ipiv), &anorm_val, &rcond, raw_data(work), &info)
	} else when Cmplx == complex128 {
		lapack.zgtcon_(&norm_c, &n_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(du2), raw_data(ipiv), &anorm_val, &rcond, raw_data(work), &info)
	}
...
tridiagonal_refine_real :: proc(
	...
	when T == f32 {
		lapack.sgtrfs_(&trans_c, &n_int, &nrhs_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(dlf), raw_data(df), raw_data(duf), raw_data(du2), raw_data(ipiv), raw_data(B.data), &ldb, raw_data(X.data), &ldx, raw_data(ferr), raw_data(berr), raw_data(work), raw_data(iwork), &info)
	} else when T == f64 {
		lapack.dgtrfs_(&trans_c, &n_int, &nrhs_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(dlf), raw_data(df), raw_data(duf), raw_data(du2), raw_data(ipiv), raw_data(B.data), &ldb, raw_data(X.data), &ldx, raw_data(ferr), raw_data(berr), raw_data(work), raw_data(iwork), &info)
	}
...
tridiagonal_refine_complex :: proc(
	...
	when Cmplx == complex64 {
		lapack.cgtrfs_(&trans_c, &n_int, &nrhs_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(dlf), raw_data(df), raw_data(duf), raw_data(du2), raw_data(ipiv), raw_data(B.data), &ldb, raw_data(X.data), &ldx, raw_data(ferr), raw_data(berr), raw_data(work), raw_data(rwork), &info)
	} else when Cmplx == complex128 {
		lapack.zgtrfs_(&trans_c, &n_int, &nrhs_int, raw_data(dl), raw_data(d), raw_data(du), raw_data(dlf), raw_data(df), raw_data(duf), raw_data(du2), raw_data(ipiv), raw_data(B.data), &ldb, raw_data(X.data), &ldx, raw_data(ferr), raw_data(berr), raw_data(work), raw_data(rwork), &info)
	}
