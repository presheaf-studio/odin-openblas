...
dns_query_workspace_solve_symmetric :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
...
dns_query_workspace_solve_symmetric_rook :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    uplo := MatrixRegion.Upper,
) -> (
...
dns_query_workspace_solve_symmetric_rk :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    uplo := MatrixRegion.Upper,
) -> (
...
dns_query_workspace_solve_symmetric_expert :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    AF: ^Matrix(T),
    X: ^Matrix(T),
...
dns_query_workspace_symmetric_condition_number :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    iwork_size: int,
...
dns_query_workspace_symmetric_equilibrate_improved :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
) where is_float(T) ||
...
dns_query_workspace_symmetric_iterative_refinement :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    iwork_size: int,
...
dns_query_workspace_symmetric_iterative_refinement_expert :: proc(
    A: ^Matrix($T),
    n_err_bnds: int = 3,
) -> (
    work_size: int,
