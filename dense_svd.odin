...
query_result_sizes_dns_svd_simple :: proc(
    A: ^Matrix($T),
    jobu: SVD_Job = .Some,
    jobvt: SVD_Job = .Some,
) -> (
...
query_workspace_dns_svd_simple :: proc(
    A: ^Matrix($T),
    jobu: SVD_Job = .Some,
    jobvt: SVD_Job = .Some,
) -> (
...
query_result_sizes_dns_svd_qr :: proc(
    A: ^Matrix($T),
    jobu: SVD_Job = .All,
    jobv: SVD_Job = .All,
) -> (
...
query_workspace_dns_svd_qr :: proc(
    A: ^Matrix($T),
    jobu: SVD_QR_JobU = .All,
    jobv: SVD_QR_JobV = .All,
    accuracy: SVD_Accuracy = .High,
    pivot: bool = true,
...
query_result_sizes_dns_svd_dc :: proc(
    A: ^Matrix($T),
    jobz: SVD_Job = .Some,
) -> (
    S_size: int,
...
query_workspace_dns_svd_dc :: proc(
    A: ^Matrix($T),
    jobz: SVD_Job = .Some,
) -> (
    work_size: int,
...
query_result_sizes_dns_svd_jacobi :: proc(
    A: ^Matrix($T),
    jobu: SVD_Jacobi_Job = .Compute,
    jobv: SVD_Jacobi_Job = .Vectors,
) -> (
...
query_workspace_dns_svd_jacobi_variant :: proc(
    A: ^Matrix($T),
...
query_result_sizes_dns_svd_jacobi_variant :: proc(
    A: ^Matrix($T),
    jobu: SVD_Jacobi_Variant_Job = .Compute,
    jobv: SVD_Jacobi_Variant_Job = .Vectors,
) -> (
...
query_workspace_dns_svd_generalized_blocked :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
...
query_workspace_dns_svd_generalized :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
...
query_workspace_dns_svd_generalized_preprocess :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
...
query_workspace_dns_svd_generalized_preprocess_blocked :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    jobu := GSVD_Job.Compute,
    jobv := GSVD_Job.Full,
