...
query_workspace_dns_solve_expert :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    rwork_size: int,
...
query_workspace_dns_condition :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    rwork_size: int,
...
query_workspace_dns_solve_refine :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    rwork_size: int,
...
query_workspace_dns_solve_mixed_precision :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
) -> (
    work_size: int,
...
query_workspace_dns_solve_refine_extended :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    rwork_size: int,
...
query_workspace_dns_solve_expert_extended :: proc(
    A: ^Matrix($T),
) -> (
    work_size: int,
    rwork_size: int,
