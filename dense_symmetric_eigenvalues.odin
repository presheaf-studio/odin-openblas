...
query_workspace_dns_eigen_symmetric :: proc(
    A: ^Matrix($T),
    jobz: EigenJobOption,
...
query_workspace_dns_eigen_symmetric_dc :: proc(
    A: ^Matrix($T),
    jobz: EigenJobOption,
    uplo := MatrixRegion.Upper,
) -> (
...
query_workspace_dns_eigen_symmetric_mrrr :: proc(
    A: ^Matrix($T),
    Z: ^Matrix(T),
...
query_workspace_dns_eigen_symmetric_expert :: proc(
    A: ^Matrix($T),
    range: EigenRangeOption,
    jobz: EigenJobOption,
    uplo: MatrixRegion,
...
query_workspace_dns_eigen_symmetric_2stage :: proc(
    A: ^Matrix($T),
    jobz: EigenJobOption,
    uplo: MatrixRegion,
) -> (
...
query_workspace_dns_eigen_symmetric_generalized :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    jobz: EigenJobOption,
    uplo: MatrixRegion,
...
query_workspace_dns_eigen_symmetric_generalized_dc :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    jobz: EigenJobOption,
    uplo: MatrixRegion,
...
query_workspace_dns_eigen_symmetric_generalized_expert :: proc(
    A: ^Matrix($T),
    B: ^Matrix(T),
    Z: ^Matrix(T),
    range: EigenRangeOption,
